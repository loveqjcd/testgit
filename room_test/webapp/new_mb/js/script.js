var App = function () {
	...
	var handleTimeline = function () {
		createStoryJS({
			...
			width:		'100%',
			height:		'600',
			source:		'../new_mb/js/timelinejs/example_json.json',
			embed_id:	'my-timeline',
			debug:		true,
			css:        '../new_mb/js/timelinejs/css/timeline.css',     
            js:         '../new_mb/js/timelinejs/js/timeline-min.js'    
		});
	}
	/*-----------------------------------------------------------------------------------*/
	/*	Handle Slidernav
	...
	var handleThemeSkins = function () {
        ...
        var setSkin = function (color) {
            $('#skin-switcher').attr("href", "../new_mb/css/themes/" + color + ".css");
