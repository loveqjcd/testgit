function zgpagination(totalProperty,currentlyPageNo,pageTotal){
	if(totalProperty > 0) {
		var html ="<ul>"
				...
				+"<li><span style='padding-left:10px;position:relative;bottom:-4px;'>页次:"+currentlyPageNo+"/"+pageTotal+"页</span></li>"
				+"<li><span style='padding-left:10px;position:relative;bottom:-4px;'>共"+totalProperty+"条记录</span></span></li>"
				+"<li><select id='select-page' style='margin-left:10px;width:100px;height:26px;line-height:26px;font-size:12px;'></select></li>"
				+"</ul>";
